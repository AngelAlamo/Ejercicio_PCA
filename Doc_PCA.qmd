...
datos_cen = sapply (datos, function (x) scale (x, scale = FALSE ))
...
```{r}
autoplot(datos_pca, data = datos_cen, loadings = TRUE, loadings.colour = 'blue',
...
#library(ggplot2)
#library("factoextra")
#datos.acp=prcomp(datos_cen, scale = FALSE)
#lambdas=get_eigenvalue(datos.acp)
#var <- get_pca_var(datos.acp)
#fviz_pca_var(datos.acp, col.var = "contrib", repel = TRUE, axes = 1:2, col.circle = "red")
```
